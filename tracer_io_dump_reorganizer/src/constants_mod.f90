...
!CHARACTER(LEN=200), PARAMETER :: output_filepath = '/data/uchu/tanzid/Wombat_Sprint_5/Tracer_FP_Tests/build/Snapshots/'     
REAL, PARAMETER :: dump_frequency = 0.2    
...
!*******************************
INTEGER, PARAMETER :: nfiles = 2         ! keep this < 10 for now
INTEGER, PARAMETER :: start_dump_num = 1022
INTEGER, PARAMETER :: ndumps_tot = 50   ! total number of time dumps to read from
INTEGER, PARAMETER :: particle_nvars = 4 ! (flattened_id, flattened_pos, B^2, divV)
LOGICAL, PARAMETER :: single_file = .FALSE.
